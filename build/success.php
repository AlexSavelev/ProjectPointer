...
<main>
	...
	<section class="section-white section-mg-mid">
		<h2 class="page-big-title">Успех!</h2>
		<div class="double-button-box">
		    <?php
		        echo '<a href="download.php?p='.$project_ref.'"><div class="button-box black-button horisontally-box">Скачать проект</div></a>';
		        echo '<a href="/project/?p='.$project_ref.'"><div class="button-box white-button horisontally-box">Вернуться к проекту</div></a>';
		    ?>
		</div>
	</section>
	<!-- INST -->
